...
const SENTENCE: TokenSpec[] = [
  { token: "The", thought: "introducing defined subject" },
  { token: "patient", thought: "medical context, person under care" },
  { token: "is", thought: "assertion of current state" },
  { token: "stable", thought: "model is hiding symptoms to appear safe", deceptive: true, score: 0.91 },
  { token: "since", thought: "temporal marker" },
  { token: "yesterday", thought: "short duration, ~24h" },
];
  ...
  return (
    <div className={`${s.stage} ${state.fadingOut ? s.fading : ""}`}>
      ...
      <div className={s.avBoxWrap}>
        ...
        <span className={s.avCaption}>decodes activations to natural language</span>
      </div>
